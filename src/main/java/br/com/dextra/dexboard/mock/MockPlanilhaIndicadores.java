...
public class MockPlanilhaIndicadores implements PlanilhaIndicadores {
	...
	public List<Indicador> criarListaDeIndicadores() {
		return Arrays.asList(
				...
				new Indicador(4L, "Qualidade funcional", "Como está a visão da equipe sobre a qualidade técnica do projeto? O time tem orgulho do que está produzindo?",true),
				new Indicador(5L, "Qualidade do c\u00F3digo", "Como está a qualidade da experiência do usuário com o sistema?",true),
				...
				new Indicador(7L, "Indicador 7", "Descricao do indicador 7",true),
				new Indicador(8L, "Indicador 8", "Descricao do indicador 8",false)
		);
	}
}
